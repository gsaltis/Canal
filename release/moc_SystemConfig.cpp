...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SystemConfig_t, stringdata0) + ofs), len 
...
const QMetaObject SystemConfig::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SystemConfig.offsetsAndSize,
    qt_meta_data_SystemConfig,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SystemConfig_t
